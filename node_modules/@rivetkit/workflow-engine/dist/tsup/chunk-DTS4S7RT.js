...
var ENTRY_VERSIONED = createVersionedDataHandler({
...
var ENTRY_METADATA_VERSIONED = createVersionedDataHandler({
  deserializeVersion: (bytes, version) => {
    switch (version) {
      case 1:
...
var WORKFLOW_METADATA_VERSIONED = createVersionedDataHandler({
  deserializeVersion: (bytes, version) => {
    switch (version) {
      case 1:
...
function entryMetadataFromBare(bareMetadata) {
  return {
    ...
    error: bareMetadata.error ?? void 0,
    ...
    rollbackError: bareMetadata.rollbackError ?? void 0,
    dirty: false
  };
}
  ...
  async executeStep(config2) {
    ...
    if (existing) {
      ...
      const backoffDelay = calculateBackoff(
        metadata2.attempts,
        config2.retryBackoffBase ?? DEFAULT_RETRY_BACKOFF_BASE,
        config2.retryBackoffMax ?? DEFAULT_RETRY_BACKOFF_MAX
      );
    ...
    metadata.dirty = true;
    const timeout = config2.timeout ?? DEFAULT_STEP_TIMEOUT;
    try {
