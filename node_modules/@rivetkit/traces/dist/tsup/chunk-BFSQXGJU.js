...
// src/read-range.ts
import { decode as decodeCbor2 } from "cbor-x";
...
function decodeAttributeList(attributes, strings) {
  ...
  for (const kv of attributes) {
    ...
    try {
      map.set(key, decodeCbor2(toUint8Array(kv.value)));
    } catch {
    }
  }
  return map;
...
function toOtlpSpan(span) {
  ...
  return {
    ...
    name: span.name,
    kind: span.kind,
    traceState: span.traceState ?? void 0,
...
function toOtlpLink(link) {
  ...
  return {
    ...
    traceState: link.traceState ?? void 0,
    attributes: attributes.length > 0 ? attributes : void 0,
...
//# sourceMappingURL=chunk-BFSQXGJU.js.map