...
var _chunkTAGZY5ZHcjs = require('./chunk-TAGZY5ZH.cjs');
...
function spanKey(spanId) {
  return _chunkTAGZY5ZHcjs.hexFromBytes.call(void 0, normalizeBytes(spanId));
}
...
function createTraces(options) {
  ...
  async function readRange(options2) {
    ...
    return _chunkTAGZY5ZHcjs.readRangeWireToOtlp.call(void 0, wire, resource);
  }
