...
function actor(input) {
  ...
  const config = _chunkHNHLBM3Ycjs.ActorConfigSchema.parse(input);
  _chunkHNHLBM3Ycjs.flattenActionHandlers.call(void 0, config.actions);
  _chunkHNHLBM3Ycjs.flattenActionInputSchemas.call(void 0, config.actions, config.actionInputSchemas);
...
var InlineWebSocketAdapter = class {
  ...
  constructor(handler, options = {}) {
    ...
    this.#restoring = _nullishCoalesce(options.restoring, () => ( false));
    ...
    try {
      ...
      const serverlessConfig = {
        serverless: {
          ...
          headers,
          request_lifespan: _nullishCoalesce(customConfig.requestLifespan, () => ( 60 * 60)),
...
var ConfigurePoolSchema = _v4.z.object({
  name: _v4.z.string().optional(),
  url: _v4.z.string(),
  headers: _v4.z.record(_v4.z.string(), _v4.z.string()).optional(),
  requestLifespan: _v4.z.number().optional(),
  drainGracePeriod: _v4.z.number().optional(),
  metadata: _v4.z.record(_v4.z.string(), _v4.z.unknown()).optional(),
  metadataPollInterval: _v4.z.number().optional(),
  drainOnVersionUpgrade: _v4.z.boolean().optional()
}).optional();
var ServerlessConfigSchema = _v4.z.object({
  // MARK: Routing
  basePath: _v4.z.string().optional().default("/api/rivet"),
  maxStartPayloadBytes: _v4.z.number().optional().default(DEFAULT_SERVERLESS_MAX_START_PAYLOAD_BYTES),
...
var RuntimeKindSchema = _zod.z.enum(["auto", "native", "wasm"]);
var SqliteBackendSchema = _zod.z.enum(["local", "remote"]);
var TestConfigSchema = _zod.z.object({
  enabled: _zod.z.boolean().optional().default(false),
  sqliteBackend: SqliteBackendSchema.optional()
});
var WasmRuntimeConfigSchema = _zod.z.object({
  bindings: _zod.z.custom().optional(),
  initInput: _zod.z.custom().optional()
});
var SqliteConfigSchema = _zod.z.union([
  SqliteBackendSchema,
  _zod.z.object({
...
var RegistryConfigSchema = _zod.z.object({
   ...
   */
  staticDir: _zod.z.string().optional(),
  /**
   * @experimental
   *
   ...
   */
  httpBasePath: _zod.z.string().optional().default("/"),
  /**
   * @experimental
   *
   * What port to run the local HTTP server on.
   */
  httpPort: _zod.z.number().optional().default(6421),
  /**
   * @experimental
   *
  ...
  const publicEndpoint = _nullishCoalesce((parsedPublicEndpoint == null ? void 0 : parsedPublicEndpoint.endpoint), () => ( (isDevEnv && !parsedEndpoint ? endpoint : void 0)));
...
function buildActorNames(config) {
  return Object.fromEntries(
    Object.keys(config.use).map((actorName) => {
      ...
      const runMeta = _chunkHNHLBM3Ycjs.getRunMetadata.call(void 0, definition.config.run);
      const metadata = {};
...
var DocConfigurePoolSchema = _zod.z.object({
  ...
  headers: _zod.z.record(_zod.z.string(), _zod.z.string()).optional().describe(
    "Headers to include in requests to the serverless platform."
  ),
  requestLifespan: _zod.z.number().optional().describe("Maximum lifespan of a request in seconds."),
  drainGracePeriod: _zod.z.number().optional().describe(
    "Grace period before the serverless request is forcibly closed, in seconds."
  ),
  metadata: _zod.z.record(_zod.z.string(), _zod.z.unknown()).optional().describe(
    "Additional metadata to pass to the serverless platform."
  ),
  metadataPollInterval: _zod.z.number().optional().describe(
    "Interval in milliseconds between metadata polls from the engine. Defaults to 10000 milliseconds (10 seconds)."
  ),
  drainOnVersionUpgrade: _zod.z.boolean().optional().describe(
    "Drain runners when a new version is deployed. Defaults to true."
  )
}).optional();
var DocServerlessConfigSchema = _zod.z.object({
  basePath: _zod.z.string().optional().describe(
    "Base path for serverless API routes. Default: '/api/rivet'"
  ),
  maxStartPayloadBytes: _zod.z.number().optional().describe(
    `Maximum POST /start body size in bytes. Default: ${DEFAULT_SERVERLESS_MAX_START_PAYLOAD_BYTES}`
  ),
  publicEndpoint: _zod.z.string().optional().describe(
    "The endpoint that clients should connect to. Supports URL auth syntax: https://namespace:token@api.rivet.dev"
  ),
  publicToken: _zod.z.string().optional().describe(
    "Token that clients should use when connecting via the public endpoint."
  )
}).describe("Configuration for serverless deployment mode.");
var DocEnvoyConfigSchema = _zod.z.object({
  totalSlots: _zod.z.number().optional().describe("Total number of actor slots available. Default: 100000"),
  poolName: _zod.z.string().optional().describe("Name of this envoy pool. Default: 'default'"),
  envoyKey: _zod.z.string().optional().describe("Deprecated. Authentication key for the envoy."),
  version: _zod.z.number().optional().describe("Version number of this envoy. Default: 1")
}).describe("Configuration for envoy mode.");
var DocSqliteConfigSchema = _zod.z.object({
...
var DocRegistryConfigSchema = _zod.z.object({
  use: _zod.z.record(_zod.z.string(), _zod.z.unknown()).describe(
    "Actor definitions. Keys are actor names, values are actor definitions."
  ),
  maxIncomingMessageSize: _zod.z.number().optional().describe(
    "Maximum size of incoming WebSocket messages in bytes. Default: 65536"
  ),
  maxOutgoingMessageSize: _zod.z.number().optional().describe(
  ...
  endpoint: _zod.z.string().optional().describe(
  ...
  staticDir: _zod.z.string().optional().describe(
    "Directory to serve static files from. When set, registry.start() serves static files alongside the actor API."
  ),
  httpBasePath: _zod.z.string().optional().describe("Base path for the local RivetKit API. Default: '/'"),
  httpPort: _zod.z.number().optional().describe("Port to run the local HTTP server on. Default: 6421"),
  httpHost: _zod.z.string().optional().describe("Host to bind the local HTTP server to."),
  startEngine: _zod.z.boolean().optional().describe(
...
function normalizeNativeMetrics(metrics) {
  ...
  const raw = metrics;
  const numberField = (camel, snake) => Number(_nullishCoalesce(_nullishCoalesce(raw[camel], () => ( raw[snake])), () => ( 0)));
  return {
  ...
  const executeNative = async (sql, params) => {
    ...
    if (lastInsertRowIdColumn) {
      return {
        ...
        rows: [[_nullishCoalesce(lastInsertRowId, () => ( 0))]],
        changes: 0,
        lastInsertRowId
      };
    }
...
function toNapiSqlBatchStatement(statement) {
  return {
    sql: statement.sql,
    params: _nullishCoalesce(toNapiSqlBindParams(statement.params), () => ( void 0))
  };
}
...
var NapiCoreRuntime = (_class = class {
  __init() {this.kind = "napi"}
  #bindings;
  #sql = /* @__PURE__ */ new WeakMap();
  constructor(bindings) {;_class.prototype.__init.call(this);
  ...
  actorSqlMetrics(ctx) {
    var _a, _b;
    return _nullishCoalesce(((_b = (_a = this.#actorSql(ctx)).metrics) == null ? void 0 : _b.call(_a)), () => ( null));
  }
  actorSqlTakeLastKvError(ctx) {
    var _a, _b;
    return _nullishCoalesce(((_b = (_a = this.#actorSql(ctx)).takeLastKvError) == null ? void 0 : _b.call(_a)), () => ( null));
  }
  ...
  async actorScheduleGet(ctx, id) {
    return await _asyncNullishCoalesce(await asNativeActorContext(ctx).schedule().get(id), async () => ( void 0));
  }
  ...
  async actorCronGet(ctx, name) {
    return await _asyncNullishCoalesce(await asNativeActorContext(ctx).schedule().cronGet(name), async () => ( void 0));
  }
...
async function loadNapiRuntime() {
  const bindings = await Promise.resolve().then(() => _interopRequireWildcard(require(["@rivetkit", "rivetkit-napi"].join("/"))));
  return {
    bindings,
...
function toBytes(value) {
  return _nullishCoalesce(value, () => ( new Uint8Array(0)));
}
...
var WasmCoreRuntime = (_class2 = class {
  __init2() {this.kind = "wasm"}
  #bindings;
  #sql = /* @__PURE__ */ new WeakMap();
  constructor(bindings) {;_class2.prototype.__init2.call(this);
    this.#bindings = bindings;
  }
  #actorSql(ctx) {
...
async function loadWasmRuntime(config) {
  const bindings = await _asyncNullishCoalesce((config == null ? void 0 : config.bindings), async () => ( await Promise.resolve().then(() => _interopRequireWildcard(require(["@rivetkit", "rivetkit-wasm"].join("/"))))));
...
function resolveRuntimeKind(runtime) {
  return _nullishCoalesce(runtime, () => ( "auto"));
}
...
function sqliteBackendForConfig(config) {
  var _a, _b;
  return _nullishCoalesce(((_a = config.sqlite) == null ? void 0 : _a.backend), () => ( ((_b = config.test) == null ? void 0 : _b.sqliteBackend)));
}
function normalizeRuntimeConfigForKind(config, runtimeKind) {
  ...
  return {
    ...
    test: {
      ...config.test,
      enabled: _nullishCoalesce(((_a = config.test) == null ? void 0 : _a.enabled), () => ( false)),
...
function queryRows(result) {
  ...
  if (result && typeof result === "object" && "columns" in result && "rows" in result && Array.isArray(result.columns) && Array.isArray(result.rows)) {
    ...
    return (_nullishCoalesce(result.rows, () => ( []))).map(
...
var NativeConnAdapter = class {
  ...
  constructor(runtime, conn, schemas = {}, ctx, queueHibernationRemoval) {
    ...
    this[_chunkHNHLBM3Ycjs.CONN_STATE_MANAGER_SYMBOL] = {
      stateEnabled: true,
      get state() {
  ...
  [_chunkHNHLBM3Ycjs.RAW_STATE_SYMBOL]() {
...
var NativeCronAdapter = class {
  ...
  async set(options) {
    await this.#runtime.actorCronSet(
      ...
      options.timezone,
      options.action,
      encodeValue(_nullishCoalesce(options.args, () => ( []))),
      options.maxHistory
    );
  }
  async every(options) {
  ...
  async get(key, options) {
    const value = await callNative(
      () => this.#runtime.actorKvGet(
        this.#ctx,
        _chunkMYWZCDMLcjs.makePrefixedKey.call(void 0, encodeNativeKvUserKey(key))
      )
    );
  ...
  async deleteRange(start, end) {
    await callNative(
      () => this.#runtime.actorKvDeleteRange(
        this.#ctx,
        _chunkMYWZCDMLcjs.makePrefixedKey.call(void 0, encodeNativeKvUserKey(start)),
        _chunkMYWZCDMLcjs.makePrefixedKey.call(void 0, encodeNativeKvUserKey(end))
      )
    );
  }
  ...
  async listPrefix(prefix, options) {
    const entries = await callNative(
      () => this.#runtime.actorKvListPrefix(
        this.#ctx,
        _chunkMYWZCDMLcjs.makePrefixedKey.call(void 0, 
    ...
    return entries.map((entry) => [
      decodeNativeKvKey(
        _chunkMYWZCDMLcjs.removePrefixFromKey.call(void 0, new Uint8Array(entry.key)),
        options == null ? void 0 : options.keyType
      ),
...
var NativeWebSocketAdapter = class {
  ...
  #ws;
  #virtual;
  #readyState = _virtualwebsocket.VirtualWebSocket.OPEN;
  constructor(runtime, ws) {
    this.#runtime = runtime;
    this.#ws = ws;
    this.#virtual = new (0, _virtualwebsocket.VirtualWebSocket)({
      getReadyState: () => this.#readyState,
      onSend: (data) => {
      ...
      onClose: (code, reason) => {
        this.#readyState = _virtualwebsocket.VirtualWebSocket.CLOSING;
        void callNative(
    ...
    this.#runtime.webSocketSetEventCallback(this.#ws, (event2) => {
      ...
      this.#readyState = _virtualwebsocket.VirtualWebSocket.CLOSED;
...
var ActorContextHandleAdapter = class {
  ...
  constructor(runtime, ctx, clientFactory, schemas = {}, databaseProvider, request, stateEnabled = true, runHandlerActiveProvider, onStateChange, dispatchCancelToken) {
    ...
    this[_chunkHNHLBM3Ycjs.ACTOR_CONTEXT_INTERNAL_SYMBOL] = new NativeWorkflowRuntimeAdapter(
      this
    );
  }
  get kv() {
  ...
  get queue() {
    if (!this.#queue) {
      this.#queue = exports.queue = new NativeQueueAdapter(
        this.#runtime,
        this.#ctx,
        this.#schemas.queues
      );
  ...
  runHandlerActive() {
    var _a;
    return _nullishCoalesce(((_a = this.#runHandlerActiveProvider) == null ? void 0 : _a.call(this)), () => ( false));
  }
    ...
    this.queueManager = {
      ...
      receive: async (names, count, timeout, _abortSignal, completable) => {
        const messages = await this.#ctx.queue.nextBatch({
          names,
          count,
          timeout: _nullishCoalesce(timeout, () => ( 0)),
          completable
        });
        return messages.map(
      ...
      waitForNames: async (names, abortSignal) => {
        await this.#ctx.queue.waitForNamesAvailable(_nullishCoalesce(names, () => ( [])), {
          signal: abortSignal
        });
      }
    };
...
function buildActorConfig(definition, registryConfig, runtimeKind) {
  ...
  return {
    ...
    actions: Object.keys(_chunkHNHLBM3Ycjs.flattenActionHandlers.call(void 0, config.actions)).sort().map((name) => ({ name })),
...
function buildNativeFactory(runtime, registryConfig, definition) {
  ...
  const actionHandlers = _chunkHNHLBM3Ycjs.flattenActionHandlers.call(void 0, config.actions);
  const schemaConfig = {
    actionInputSchemas: _chunkHNHLBM3Ycjs.flattenActionInputSchemas.call(void 0, 
      config.actions,
  ...
  const isNativeRunHandlerActive = (ctx) => _nullishCoalesce(nativeRunHandlerActiveByActorId.get(
    callNativeSync(() => runtime.actorId(ctx))
  ), () => ( false));
  const getNativeWorkflowInspector = (ctx) => {
    var _a2;
    return (_a2 = _chunkHNHLBM3Ycjs.getRunInspectorConfig.call(void 0, 
      config.run,
      callNativeSync(() => runtime.actorId(ctx))
  ...
  const maybeHandleNativeInspectorRequest = async (ctx, _rawRequest, jsRequest) => {
    ...
    const jsonResponse = (body, init) => new Response(JSON.stringify(body), {
      ...
      headers: {
        ...
        ..._nullishCoalesce((init == null ? void 0 : init.headers), () => ( {}))
      }
    });
      ...
      return jsonResponse(
        {
          ...
          metadata: _nullishCoalesce(rivetError.metadata, () => ( null))
        },
        {
          status: _nullishCoalesce(_nullishCoalesce(status, () => ( rivetError.statusCode)), () => ( (rivetError.public ? 400 : 500)))
        }
      );
    };
    ...
    const workflowHistory = () => {
      ...
      return serializeWorkflowHistoryForJson(
        _nullishCoalesce(((_a3 = getNativeWorkflowInspector(ctx)) == null ? void 0 : _a3.getHistory()), () => ( null))
      );
    };
    const workflowState = async () => {
      var _a3, _b2;
      return await _asyncNullishCoalesce(await ((_b2 = (_a3 = getNativeWorkflowInspector(ctx)) == null ? void 0 : _a3.getState) == null ? void 0 : _b2.call(_a3)), async () => ( null));
    };
    ...
    try {
      ...
      if (url.pathname === "/inspector/database/schema" && jsRequest.method === "GET") {
        ...
        for (const table of tables) {
          ...
          tableInfos.push({
            ...
            records: _nullishCoalesce(((_d = countResult[0]) == null ? void 0 : _d.count), () => ( 0))
          });
        }
      ...
      if (url.pathname === "/inspector/database/rows" && jsRequest.method === "GET") {
        ...
        const limit = Number.parseInt(
          _nullishCoalesce(url.searchParams.get("limit"), () => ( "100")),
          10
        );
        const offset = Number.parseInt(
          _nullishCoalesce(url.searchParams.get("offset"), () => ( "0")),
          10
        );
  ...
  const callbacks = {
    ...
    onDestroy: wrapNativeCallback(
      async (error, payload) => {
        ...
        try {
          ...
          _chunkHNHLBM3Ycjs.disposeRunInspector.call(void 0, config.run, actorId);
    ...
    run: (() => {
      const run = _chunkHNHLBM3Ycjs.getRunFunction.call(void 0, config.run);
      if (!run) {
        return void 0;
      }
    ...
    getWorkflowHistory: _chunkHNHLBM3Ycjs.getRunInspectorConfig.call(void 0, config.run) !== void 0 ? wrapNativeCallback(
      async (error, payload) => {
        var _a2;
        const { ctx } = unwrapTsfnPayload(error, payload);
    ...
    replayWorkflow: _chunkHNHLBM3Ycjs.getRunInspectorConfig.call(void 0, config.run) !== void 0 ? wrapNativeCallback(
      async (error, payload) => {
        ...
        const history = await _asyncNullishCoalesce(await workflowInspector.replayFromStep(
          entryId
        ), async () => ( null));
        return history == null ? void 0 : encodeValue(history);
      }
...
var Registry = class {
  ...
  async handler(request) {
    ...
    const isStartRequest = isServerlessStartRequest(
      request,
      _nullishCoalesce(serveConfig.serverlessBasePath, () => ( "/api/rivet"))
    );
    const isMetadataRequest = isServerlessMetadataRequest(
      request,
      _nullishCoalesce(serveConfig.serverlessBasePath, () => ( "/api/rivet"))
    );
    const isEngineMetadataRequest = _nullishCoalesce(((_a = request.headers.get("user-agent")) == null ? void 0 : _a.startsWith("RivetEngine/")), () => ( false));
    if (isStartRequest) {
      try {
    ...
    const resolveBackpressure = () => {
      var _a2;
      while (controllerRef && (_nullishCoalesce(controllerRef.desiredSize, () => ( 1))) > 0 && backpressureWaiters.length > 0) {
        (_a2 = backpressureWaiters.shift()) == null ? void 0 : _a2();
      }
    };
    const waitForBackpressure = async () => {
      if (!controllerRef || (_nullishCoalesce(controllerRef.desiredSize, () => ( 1))) > 0) return;
