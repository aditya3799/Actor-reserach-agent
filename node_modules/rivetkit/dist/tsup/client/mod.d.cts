...
declare const ClientConfigSchema: z.ZodPipe<z.ZodObject<{
    ...
    gateway: z.ZodDefault<z.ZodOptional<z.ZodObject<{
        skipReadyWait: z.ZodDefault<z.ZodOptional<z.ZodBoolean>>;
    }, z.core.$strip>>>;
...
export { ActorClientError, ActorConnDisposed, Client, type ClientConfigInput, MalformedResponseMessage, ManagerError, createClient };
