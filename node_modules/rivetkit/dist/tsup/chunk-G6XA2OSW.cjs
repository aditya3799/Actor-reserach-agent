...
function writeWorkflowVersionCheckEntry(bc, x) {
...
// src/common/inspector-transport.ts
function encodeWorkflowHistoryTransport(history) {
  return _chunkZ2ESFE5Zcjs.bufferToArrayBuffer.call(void 0, encodeWorkflowHistory(history));
}
function decodeWorkflowHistoryTransport(data) {
  return decodeWorkflowHistory(_chunkZ2ESFE5Zcjs.toUint8Array.call(void 0, data));
}
...
//# sourceMappingURL=chunk-G6XA2OSW.cjs.map