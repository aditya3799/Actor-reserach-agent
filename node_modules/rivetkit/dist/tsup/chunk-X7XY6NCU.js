...
function assertJsonCompatValue(value, path = "") {
  ...
  const typeName = typeof value === "object" && value !== null ? ((_a = value.constructor) == null ? void 0 : _a.name) ?? typeof value : typeof value;
  throw new TypeError(
...
function encodeJsonCompatValue(input) {
  ...
  const typeName = typeof input === "object" && input !== null ? ((_a = input.constructor) == null ? void 0 : _a.name) ?? typeof input : typeof input;
...
//# sourceMappingURL=chunk-X7XY6NCU.js.map