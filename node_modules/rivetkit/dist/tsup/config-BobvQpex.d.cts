...
import { A as AnyDatabaseProvider, d as SqliteNativeMetrics, I as InferDatabaseClient } from './config-BxOimoGX.cjs';
 ...
 */
declare const CrashPolicySchema: z.ZodEnum<{
    restart: "restart";
    sleep: "sleep";
    destroy: "destroy";
}>;
type CrashPolicy = z.infer<typeof CrashPolicySchema>;
...
type RuntimeKind = z$1.infer<typeof RuntimeKindSchema>;
type WasmRuntimeBindings = typeof _rivetkit_rivetkit_wasm;
type WasmRuntimeInitInput = Parameters<WasmRuntimeBindings["default"]>[0];
declare const SqliteBackendSchema: z$1.ZodEnum<{
    local: "local";
    remote: "remote";
}>;
type SqliteBackend = z$1.infer<typeof SqliteBackendSchema>;
declare const TestConfigSchema: z$1.ZodObject<{
    enabled: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodBoolean>>;
    sqliteBackend: z$1.ZodOptional<z$1.ZodEnum<{
        local: "local";
        remote: "remote";
    }>>;
}, z$1.core.$strip>;
type TestConfig = z$1.infer<typeof TestConfigSchema>;
declare const WasmRuntimeConfigSchema: z$1.ZodObject<{
    bindings: z$1.ZodOptional<z$1.ZodCustom<typeof _rivetkit_rivetkit_wasm, typeof _rivetkit_rivetkit_wasm>>;
    initInput: z$1.ZodOptional<z$1.ZodCustom<any, any>>;
}, z$1.core.$strip>;
type WasmRuntimeConfig = z$1.infer<typeof WasmRuntimeConfigSchema>;
declare const SqliteConfigSchema: z$1.ZodPipe<z$1.ZodOptional<z$1.ZodUnion<readonly [z$1.ZodEnum<{
    local: "local";
    remote: "remote";
}>, z$1.ZodObject<{
    backend: z$1.ZodEnum<{
...
type SqliteConfig = z$1.infer<typeof SqliteConfigSchema>;
declare const RegistryConfigSchema: z$1.ZodPipe<z$1.ZodObject<{
    ...
    runtime: z$1.ZodPipe<z$1.ZodOptional<z$1.ZodEnum<{
        auto: "auto";
        native: "native";
        wasm: "wasm";
    }>>, z$1.ZodTransform<"auto" | "native" | "wasm", "auto" | "native" | "wasm" | undefined>>;
    wasm: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodObject<{
        bindings: z$1.ZodOptional<z$1.ZodCustom<typeof _rivetkit_rivetkit_wasm, typeof _rivetkit_rivetkit_wasm>>;
        initInput: z$1.ZodOptional<z$1.ZodCustom<any, any>>;
    }, z$1.core.$strip>>>;
    sqlite: z$1.ZodPipe<z$1.ZodOptional<z$1.ZodUnion<readonly [z$1.ZodEnum<{
        local: "local";
        remote: "remote";
    }>, z$1.ZodObject<{
        backend: z$1.ZodEnum<{
    ...
    staticDir: z$1.ZodOptional<z$1.ZodString>;
    httpBasePath: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodString>>;
    ...
    configurePool: z$1.ZodOptional<z$1.ZodOptional<z$1.ZodObject<{
        ...
        drainGracePeriod: z$1.ZodOptional<z$1.ZodNumber>;
    ...
    serverless: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodObject<{
        ...
        maxStartPayloadBytes: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodNumber>>;
    ...
    envoy: z$1.ZodDefault<z$1.ZodOptional<z$1.ZodObject<{
        poolName: z$1.ZodDefault<z$1.ZodString>;
...
declare const DocConfigurePoolSchema: z$1.ZodOptional<z$1.ZodObject<{
    name: z$1.ZodOptional<z$1.ZodString>;
    url: z$1.ZodString;
    headers: z$1.ZodOptional<z$1.ZodRecord<z$1.ZodString, z$1.ZodString>>;
    requestLifespan: z$1.ZodOptional<z$1.ZodNumber>;
...
declare const DocServerlessConfigSchema: z$1.ZodObject<{
    basePath: z$1.ZodOptional<z$1.ZodString>;
    maxStartPayloadBytes: z$1.ZodOptional<z$1.ZodNumber>;
    publicEndpoint: z$1.ZodOptional<z$1.ZodString>;
    publicToken: z$1.ZodOptional<z$1.ZodString>;
}, z$1.core.$strip>;
declare const DocEnvoyConfigSchema: z$1.ZodObject<{
    totalSlots: z$1.ZodOptional<z$1.ZodNumber>;
    poolName: z$1.ZodOptional<z$1.ZodString>;
    envoyKey: z$1.ZodOptional<z$1.ZodString>;
    version: z$1.ZodOptional<z$1.ZodNumber>;
}, z$1.core.$strip>;
declare const DocSqliteConfigSchema: z$1.ZodOptional<z$1.ZodObject<{
    backend: z$1.ZodOptional<z$1.ZodEnum<{
        local: "local";
        remote: "remote";
    }>>;
}, z$1.core.$strip>>;
declare const DocRegistryConfigSchema: z$1.ZodObject<{
    use: z$1.ZodRecord<z$1.ZodString, z$1.ZodUnknown>;
    maxIncomingMessageSize: z$1.ZodOptional<z$1.ZodNumber>;
    maxOutgoingMessageSize: z$1.ZodOptional<z$1.ZodNumber>;
    noWelcome: z$1.ZodOptional<z$1.ZodBoolean>;
    sqlite: z$1.ZodOptional<z$1.ZodObject<{
        backend: z$1.ZodOptional<z$1.ZodEnum<{
            local: "local";
            remote: "remote";
        }>>;
    }, z$1.core.$strip>>;
    logging: z$1.ZodOptional<z$1.ZodObject<{
        level: z$1.ZodOptional<z$1.ZodEnum<{
            fatal: "fatal";
            error: "error";
            warn: "warn";
    ...
    headers: z$1.ZodOptional<z$1.ZodRecord<z$1.ZodString, z$1.ZodString>>;
    staticDir: z$1.ZodOptional<z$1.ZodString>;
    httpBasePath: z$1.ZodOptional<z$1.ZodString>;
    ...
    serverless: z$1.ZodOptional<z$1.ZodObject<{
        basePath: z$1.ZodOptional<z$1.ZodString>;
        maxStartPayloadBytes: z$1.ZodOptional<z$1.ZodNumber>;
        publicEndpoint: z$1.ZodOptional<z$1.ZodString>;
        publicToken: z$1.ZodOptional<z$1.ZodString>;
    }, z$1.core.$strip>>;
    envoy: z$1.ZodOptional<z$1.ZodObject<{
        totalSlots: z$1.ZodOptional<z$1.ZodNumber>;
        poolName: z$1.ZodOptional<z$1.ZodString>;
        envoyKey: z$1.ZodOptional<z$1.ZodString>;
        version: z$1.ZodOptional<z$1.ZodNumber>;
...
type AnyActorInstance = BaseActorInstance<any, any, any, any, any, any, any, any>;
type AnyStaticActorInstance = AnyActorInstance;
declare function isStaticActorInstance(_actor: AnyActorInstance): _actor is AnyStaticActorInstance;
declare function actor<TState, TConnParams, TConnState, TVars, TInput, TDatabase extends AnyDatabaseProvider, TEvents extends EventSchemaConfig = Record<never, never>, TQueues extends QueueSchemaConfig = Record<never, never>, TActions extends Actions<TState, TConnParams, TConnState, TVars, TInput, TDatabase, TEvents, TQueues> = Actions<TState, TConnParams, TConnState, TVars, TInput, TDatabase, TEvents, TQueues>>(input: ActorConfigInput<TState, TConnParams, TConnState, TVars, TInput, TDatabase, TEvents, TQueues, TActions>): ActorDefinition<TState, TConnParams, TConnState, TVars, TInput, TDatabase, TEvents, TQueues, TActions>;
declare function isStaticActorDefinition(definition: AnyActorDefinition): definition is AnyStaticActorDefinition;
...
declare function createClientWithDriver<A extends Registry<any>>(driver: EngineControlClient, config?: {
    encoding?: Encoding;
...
type GlobalActorOptionsInput = z.input<typeof GlobalActorOptionsSchema>;
declare const InstanceActorOptionsSchema: z.ZodPrefault<z.ZodObject<{
    createVarsTimeout: z.ZodDefault<z.ZodNumber>;
    createConnStateTimeout: z.ZodDefault<z.ZodNumber>;
    onBeforeConnectTimeout: z.ZodDefault<z.ZodNumber>;
    onConnectTimeout: z.ZodDefault<z.ZodNumber>;
    onMigrateTimeout: z.ZodDefault<z.ZodNumber>;
    sleepGracePeriod: z.ZodDefault<z.ZodNumber>;
...
type InstanceActorOptions = z.infer<typeof InstanceActorOptionsSchema>;
type InstanceActorOptionsInput = z.input<typeof InstanceActorOptionsSchema>;
...
type ActorOptions = z.infer<typeof ActorOptionsSchema>;
type ActorOptionsInput = z.input<typeof ActorOptionsSchema>;
declare const ActorConfigSchema: z.ZodObject<{
    ...
    onMigrate: z.ZodOptional<z.ZodCustom<(...args: unknown[]) => unknown, (...args: unknown[]) => unknown>>;
...
declare const DocActorOptionsSchema: z.ZodObject<{
    ...
    onBeforeConnectTimeout: z.ZodOptional<z.ZodNumber>;
    onConnectTimeout: z.ZodOptional<z.ZodNumber>;
    sleepGracePeriod: z.ZodOptional<z.ZodNumber>;
    onDestroyTimeout: z.ZodOptional<z.ZodNumber>;
    waitUntilTimeout: z.ZodOptional<z.ZodNumber>;
...
declare const DocActorConfigSchema: z.ZodObject<{
    ...
    onMigrate: z.ZodOptional<z.ZodUnknown>;
    ...
    actionInputSchemas: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    connParamsSchema: z.ZodOptional<z.ZodUnknown>;
    events: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
    queues: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodUnknown>>;
