...
function flattenActionInputSchemas(actions, schemas) {
  ...
  for (const { name, path } of collectActionEntries(actions)) {
    ...
    const schema = _nullishCoalesce(nestedSchema, () => ( flatSchema));
    if (schema !== void 0) {
...
function collectActionEntries(actions) {
  ...
  visitActionGroup(_nullishCoalesce(actions, () => ( {})), [], entries, names);
  return entries;
}
...
var zActionTree = _v4.z.custom((value) => {
  if (typeof value !== "object" || value === null || Array.isArray(value)) {
    return false;
  }
  const prototype = Object.getPrototypeOf(value);
...
var GlobalActorOptionsBaseSchema = _v4.z.object({
  ...
  enableActorRuntimeSocket: _v4.z.boolean().default(false),
  /**
...
var InstanceActorOptionsBaseSchema = _v4.z.object({
  ...
  maxSchedules: _v4.z.number().int().nonnegative().default(1e3),
...
var DocActorOptionsSchema = _v4.z.object({
  ...
  enableActorRuntimeSocket: _v4.z.boolean().optional().describe(
  ...
  maxSchedules: _v4.z.number().int().nonnegative().optional().describe(
...
exports.agentOs = agentOs; exports.agentOsActorConfigSchema = agentOsActorConfigSchema; exports.buildConfigActions = buildConfigActions; exports.buildCronActions = buildCronActions; exports.buildFilesystemActions = buildFilesystemActions; exports.buildNetworkActions = buildNetworkActions; exports.buildOnRequestHandler = buildOnRequestHandler; exports.buildPreviewActions = buildPreviewActions; exports.buildProcessActions = buildProcessActions; exports.buildPromptActions = buildPromptActions; exports.buildSessionActions = buildSessionActions; exports.buildSessionPersistenceActions = buildSessionPersistenceActions; exports.buildShellActions = buildShellActions; exports.createDatabaseVfs = createDatabaseVfs; exports.ensureVm = ensureVm; exports.generateToken = generateToken; exports.migrateAgentOsTables = migrateAgentOsTables; exports.runHook = runHook; exports.subscribeToSession = subscribeToSession; exports.syncPreventSleep = syncPreventSleep;
