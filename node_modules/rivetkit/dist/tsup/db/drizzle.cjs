  ...
  return {
    createClient: async (ctx) => {
      ...
      const createDrizzleClient = (target, transactionScoped = false) => {
        const runSql = async (query, params, method) => {
          ...
          try {
            const { rows } = await target.execute(
              query,
              _chunkUEULFXUIcjs.toSqliteBindings.call(void 0, params)
            );
            if (method === "run") {
              return { rows: [] };
            }
        ...
        const drizzleDb = _sqliteproxy.drizzle.call(void 0, callback, {
          schema
        });
...
async function runMigrations(db2, migrations) {
  ...
  const lastMigration = _nullishCoalesce(((_a = rows[0]) == null ? void 0 : _a.created_at), () => ( 0));
  ...
  try {
    if (args.length > 0) {
      const { rows, columns } = await db2.execute(
        query,
        _chunkUEULFXUIcjs.toSqliteBindings.call(void 0, args)
      );
...
exports.alias = _sqlitecore.alias; exports.check = _sqlitecore.check; exports.db = db; exports.defineConfig = defineConfig; exports.foreignKey = _sqlitecore.foreignKey; exports.index = _sqlitecore.index; exports.integer = _sqlitecore.integer; exports.primaryKey = _sqlitecore.primaryKey; exports.sqliteTable = _sqlitecore.sqliteTable; exports.sqliteTableCreator = _sqlitecore.sqliteTableCreator; exports.text = _sqlitecore.text; exports.unique = _sqlitecore.unique; exports.uniqueIndex = _sqlitecore.uniqueIndex;
