...
async function releaseSharedV8Runtime() {
...
export class NodeExecutionDriver {
    ...
    async executeInternal(options) {
        ...
        try {
            ...
            }, timingMitigation, frozenTimeMs, sessionMode, options.filePath, bindingKeys);
            ...
            if (options.mode === "run" && result.exports) {
                try {
                    if (typeof globalThis.Bun !== "undefined") {
                        ...
                        exports = cbor.decode(Buffer.from(result.exports));
                    }
                    else {
