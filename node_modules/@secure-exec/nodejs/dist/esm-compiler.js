...
const STATIC_BUILTIN_WRAPPER_SOURCES = {
    ...
    async_hooks: buildWrapperSource(STATIC_BUILTIN_BINDINGS.async_hooks, BUILTIN_NAMED_EXPORTS.async_hooks),
    perf_hooks: buildWrapperSource(STATIC_BUILTIN_BINDINGS.perf_hooks, BUILTIN_NAMED_EXPORTS.perf_hooks),
    worker_threads: buildWrapperSource(STATIC_BUILTIN_BINDINGS.worker_threads, BUILTIN_NAMED_EXPORTS.worker_threads ?? []),
    diagnostics_channel: buildWrapperSource(STATIC_BUILTIN_BINDINGS.diagnostics_channel, BUILTIN_NAMED_EXPORTS.diagnostics_channel ?? []),
    ...
    readline: buildWrapperSource(STATIC_BUILTIN_BINDINGS.readline, BUILTIN_NAMED_EXPORTS.readline ?? []),
    "path/win32": buildWrapperSource(STATIC_BUILTIN_BINDINGS["path/win32"], BUILTIN_NAMED_EXPORTS.path ?? []),
    "path/posix": buildWrapperSource(STATIC_BUILTIN_BINDINGS["path/posix"], BUILTIN_NAMED_EXPORTS.path ?? []),
};
