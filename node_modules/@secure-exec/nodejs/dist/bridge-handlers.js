 ...
 */
function resolvePackageImportSync(specifier, startDir, mode = "require") {
    let cur = startDir;
...
export function buildModuleResolutionBridgeHandlers(deps) {
            ...
            if (!resolved) {
                ...
                if (sandboxDir.startsWith(nmPrefix)) {
                    ...
                    for (const searchPath of paths) {
                        try {
                            const pkgJsonPath = hostRequire.resolve(`${pkgName}/package.json`, { paths: [searchPath] });
    ...
    handlers[K.loadFileSync] = (filePath) => {
        ...
        if (sandboxPath.includes("balanced"))
            console.error(`[loadFileSync] path=${sandboxPath}`);
