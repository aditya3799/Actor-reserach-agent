...
export type HostMessage = AuthenticateMsg | CreateSessionMsg | DestroySessionMsg | ExecuteMsg | InjectGlobalsMsg | BridgeResponseMsg | StreamEventMsg | TerminateExecutionMsg;
...
export type RustMessage = BridgeCallMsg | ExecutionResultMsg | LogMsg | StreamCallbackMsg;
