...
var BASE_TAG_SET = /* @__PURE__ */ new Set([
  ...NUMERIC_TAG,
  "bool",
  "str"
]);
...
function checkUnionInvariants(c, type) {
  ...
  for (const ty of type.types) {
    const stringifiedType = JSON.stringify(withoutExtra(ty));
  ...
  if (type.extra?.flat) {
    ...
    if (!isFlatUnion && type.types.every((t) => t.tag === "alias" || t.tag === "struct")) {
