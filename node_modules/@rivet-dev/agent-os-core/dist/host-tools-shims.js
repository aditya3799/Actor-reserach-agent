...
const NETWORK_ERROR_JSON = '{"ok":false,"error":"INTERNAL_ERROR","message":"Could not reach host tools server"}';
const MISSING_PORT_JSON = '{"ok":false,"error":"INTERNAL_ERROR","message":"AGENTOS_TOOLS_PORT not set. Host tools not available."}';
function buildCommonRuntime(toolkitName) {
 ...
 */
export function generateToolkitShim(toolkitName) {
 ...
 */
export function generateMasterShim() {
    return `#!/usr/bin/env node
${buildCommonRuntime()}
 ...
 */
export async function createShimFilesystem(toolkits) {
