...
export declare class FDEntry {
    ...
    constructor(resource: FDResource, filetype: WasiFiletype, rightsBase: bigint, rightsInheriting: bigint, fdflags: number, path?: string, fileDescription?: FileDescription);
}
/**
...
//# sourceMappingURL=wasi-types.d.ts.map